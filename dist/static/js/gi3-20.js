...
(function () {
  ...
  "/Users/evgenyzhernoklev/Projects/gi3-20/node_modules/clipboard/dist/clipboard.js": [function (require, module, exports) {
    /*!
     * clipboard.js v2.0.6
  ...
  "/Users/evgenyzhernoklev/Projects/gi3-20/src/static/js/copy.js": [function (require, module, exports) {
    "use strict";
    ...
    var Copy = /*#__PURE__*/function () {
      ...
      _createClass(Copy, [{
        key: "init",
        value: function init() {
          new _clipboard["default"](this.button);
        }
      }]);
    ...
    "clipboard": "/Users/evgenyzhernoklev/Projects/gi3-20/node_modules/clipboard/dist/clipboard.js"
  }],
  "/Users/evgenyzhernoklev/Projects/gi3-20/src/static/js/dropdown.js": [function (require, module, exports) {
    "use strict";
    ...
    var Dropdowns = /*#__PURE__*/function () {
      ...
      _createClass(Dropdowns, [{
        ...
        key: "_checkDropdown",
        value: function _checkDropdown(e) {
          var $target = $(e.target);

          if (!$target.closest('.js-dropdown').length) {
            this._hideAllDropdowns();
          } else {
            var $link = $target.closest('.js-dropdown-link');
        ...
        value: function _hideAllDropdowns() {
          $('.js-dropdown-link').removeClass('is-active');
          $('.js-dropdown').removeClass('is-active').find('.js-dropdown-content').stop().slideUp(this.DURATION);
        }
      }, {
        key: "_showDropdown",
        value: function _showDropdown($link) {
          $link.addClass('is-active').closest('.js-dropdown').addClass('is-active').find('.js-dropdown-content').stop().slideDown(this.DURATION);
        }
      }]);
  ...
  "/Users/evgenyzhernoklev/Projects/gi3-20/src/static/js/gi3-20.js": [function (require, module, exports) {
    ...
    var _copy = _interopRequireDefault(require("../js/copy"));
    ...
    var Tabs = /*#__PURE__*/function () {
      ...
      _createClass(Tabs, [{
        ...
        value: function switchContent(e) {
          e.preventDefault();
          var $target = $(e.target).closest('.js-tabs-link'),
          ...
          this.$contents.each(function () {
            var itemAttr = $(this).data('content');
